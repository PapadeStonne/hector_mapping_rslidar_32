...
(cl:defmethod cl:initialize-instance :after ((m <BumperEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BumperEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<BumperEvent> is deprecated: use youibot_msgs-msg:BumperEvent instead.")))

(cl:ensure-generic-function 'bumper-val :lambda-list '(m))
(cl:defmethod bumper-val ((m <BumperEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:bumper-val is deprecated.  Use youibot_msgs-msg:bumper instead.")
  (bumper m))
