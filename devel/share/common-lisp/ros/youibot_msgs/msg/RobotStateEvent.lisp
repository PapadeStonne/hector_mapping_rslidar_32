...
(cl:defmethod cl:initialize-instance :after ((m <RobotStateEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStateEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<RobotStateEvent> is deprecated: use youibot_msgs-msg:RobotStateEvent instead.")))
