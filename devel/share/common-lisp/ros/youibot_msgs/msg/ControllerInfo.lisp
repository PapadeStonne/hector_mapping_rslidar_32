...
(cl:defmethod cl:initialize-instance :after ((m <ControllerInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControllerInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<ControllerInfo> is deprecated: use youibot_msgs-msg:ControllerInfo instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <ControllerInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:type-val is deprecated.  Use youibot_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'p_gain-val :lambda-list '(m))
(cl:defmethod p_gain-val ((m <ControllerInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:p_gain-val is deprecated.  Use youibot_msgs-msg:p_gain instead.")
  (p_gain m))

(cl:ensure-generic-function 'i_gain-val :lambda-list '(m))
(cl:defmethod i_gain-val ((m <ControllerInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:i_gain-val is deprecated.  Use youibot_msgs-msg:i_gain instead.")
  (i_gain m))

(cl:ensure-generic-function 'd_gain-val :lambda-list '(m))
(cl:defmethod d_gain-val ((m <ControllerInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:d_gain-val is deprecated.  Use youibot_msgs-msg:d_gain instead.")
  (d_gain m))
