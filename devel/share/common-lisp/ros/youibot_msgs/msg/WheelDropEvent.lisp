...
(cl:defmethod cl:initialize-instance :after ((m <WheelDropEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelDropEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<WheelDropEvent> is deprecated: use youibot_msgs-msg:WheelDropEvent instead.")))

(cl:ensure-generic-function 'wheel-val :lambda-list '(m))
(cl:defmethod wheel-val ((m <WheelDropEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:wheel-val is deprecated.  Use youibot_msgs-msg:wheel instead.")
  (wheel m))
