...
(cl:defmethod cl:initialize-instance :after ((m <CliffEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CliffEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<CliffEvent> is deprecated: use youibot_msgs-msg:CliffEvent instead.")))

(cl:ensure-generic-function 'sensor-val :lambda-list '(m))
(cl:defmethod sensor-val ((m <CliffEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:sensor-val is deprecated.  Use youibot_msgs-msg:sensor instead.")
  (sensor m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <CliffEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:state-val is deprecated.  Use youibot_msgs-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'bottom-val :lambda-list '(m))
(cl:defmethod bottom-val ((m <CliffEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:bottom-val is deprecated.  Use youibot_msgs-msg:bottom instead.")
  (bottom m))
