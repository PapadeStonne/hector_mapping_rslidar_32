...
(cl:defmethod cl:initialize-instance :after ((m <DigitalOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<DigitalOutput> is deprecated: use youibot_msgs-msg:DigitalOutput instead.")))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <DigitalOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:values-val is deprecated.  Use youibot_msgs-msg:values instead.")
  (values m))

(cl:ensure-generic-function 'mask-val :lambda-list '(m))
(cl:defmethod mask-val ((m <DigitalOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:mask-val is deprecated.  Use youibot_msgs-msg:mask instead.")
  (mask m))
