...
(cl:defmethod cl:initialize-instance :after ((m <KeyboardInput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyboardInput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<KeyboardInput> is deprecated: use youibot_msgs-msg:KeyboardInput instead.")))

(cl:ensure-generic-function 'pressedKey-val :lambda-list '(m))
(cl:defmethod pressedKey-val ((m <KeyboardInput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:pressedKey-val is deprecated.  Use youibot_msgs-msg:pressedKey instead.")
  (pressedKey m))
