...
(cl:defmethod cl:initialize-instance :after ((m <VersionInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VersionInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<VersionInfo> is deprecated: use youibot_msgs-msg:VersionInfo instead.")))

(cl:ensure-generic-function 'hardware-val :lambda-list '(m))
(cl:defmethod hardware-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:hardware-val is deprecated.  Use youibot_msgs-msg:hardware instead.")
  (hardware m))

(cl:ensure-generic-function 'firmware-val :lambda-list '(m))
(cl:defmethod firmware-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:firmware-val is deprecated.  Use youibot_msgs-msg:firmware instead.")
  (firmware m))

(cl:ensure-generic-function 'software-val :lambda-list '(m))
(cl:defmethod software-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:software-val is deprecated.  Use youibot_msgs-msg:software instead.")
  (software m))

(cl:ensure-generic-function 'udid-val :lambda-list '(m))
(cl:defmethod udid-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:udid-val is deprecated.  Use youibot_msgs-msg:udid instead.")
  (udid m))

(cl:ensure-generic-function 'features-val :lambda-list '(m))
(cl:defmethod features-val ((m <VersionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:features-val is deprecated.  Use youibot_msgs-msg:features instead.")
  (features m))
