...
(cl:defmethod cl:initialize-instance :after ((m <ButtonEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ButtonEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<ButtonEvent> is deprecated: use youibot_msgs-msg:ButtonEvent instead.")))

(cl:ensure-generic-function 'button-val :lambda-list '(m))
(cl:defmethod button-val ((m <ButtonEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:button-val is deprecated.  Use youibot_msgs-msg:button instead.")
  (button m))
