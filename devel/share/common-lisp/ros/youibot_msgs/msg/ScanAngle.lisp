...
(cl:defmethod cl:initialize-instance :after ((m <ScanAngle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanAngle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<ScanAngle> is deprecated: use youibot_msgs-msg:ScanAngle instead.")))
...
(cl:defmethod scan_angle-val ((m <ScanAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:scan_angle-val is deprecated.  Use youibot_msgs-msg:scan_angle instead.")
  (scan_angle m))
