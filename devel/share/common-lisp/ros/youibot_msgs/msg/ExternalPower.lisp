...
(cl:defmethod cl:initialize-instance :after ((m <ExternalPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExternalPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<ExternalPower> is deprecated: use youibot_msgs-msg:ExternalPower instead.")))

(cl:ensure-generic-function 'source-val :lambda-list '(m))
(cl:defmethod source-val ((m <ExternalPower>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youibot_msgs-msg:source-val is deprecated.  Use youibot_msgs-msg:source instead.")
  (source m))
