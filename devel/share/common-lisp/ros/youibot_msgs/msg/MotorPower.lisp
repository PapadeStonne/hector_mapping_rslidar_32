...
(cl:defmethod cl:initialize-instance :after ((m <MotorPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youibot_msgs-msg:<MotorPower> is deprecated: use youibot_msgs-msg:MotorPower instead.")))
